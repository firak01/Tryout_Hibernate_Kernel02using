...
public class HibernateConfigurationProviderAssociationOneToManyWithTablesXXX extends HibernateConfigurationProviderZZZ {
    public HibernateConfigurationProviderAssociationOneToManyWithTablesXXX() throws ExceptionZZZ{
    	super();
    }
